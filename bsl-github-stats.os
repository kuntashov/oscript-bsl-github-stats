	...
	Попытка
		Пока Истина Цикл
			...
			Для каждого ЭлементРезультата из СтруктураРезультатов.ЭлементыРезультатаПоиска Цикл
				...
				ТекащаяКоллекцияПоиска[ЭлементРезультата.ИмяПользователя + "/" + ЭлементРезультата.ИмяРепозитория] = ЭлементРезультата.ИмяПользователя + "/" + ЭлементРезультата.ИмяРепозитория;
...
Процедура ВывестиРезультатыПоискаВMarkdown()
	...
	ЖурналРаботы.Информация("=========================================================================");
	ЖурналРаботы.Информация("========================== РЕПОЗИТОРИИ BSL ==============================");
	ЖурналРаботы.Информация("=========================================================================");
	Для каждого Элемент из РепозиторииBSL Цикл
		ЖурналРаботы.Информация(Элемент.Значение);
	КонецЦикла;

	ЖурналРаботы.Информация("=========================================================================");
	ЖурналРаботы.Информация("========================== РЕПОЗИТОРИИ OS +==============================");
	ЖурналРаботы.Информация("=========================================================================");
	Для каждого Элемент из РепозиторииBSL Цикл
		ЖурналРаботы.Информация(Элемент.Значение);
	КонецЦикла;
